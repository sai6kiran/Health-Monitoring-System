...
dc.filterSingle1 = function (group) {
    var charts = dc.chartRegistry.list(group);
    charts[0].filterAll();
};
...
function addTable() {
    var dataSet = window.mcldataset;
    console.log(dataSet);
    //var tbl = document.getElementById("metric_results");
    //if(tbl) tbl.parentNode.removeChild(tbl);
    console.log(window.state);

    var Table = document.getElementById("metric_results");
    Table.innerHTML = "";
    ...
    if(window.state == null) {
     ...
     dataSet.forEach(function(d) {
         if(d.school_state==window.state) {
             var temp = [];
             temp.push(d.primary_focus_subject);
             temp.push(d.primary_focus_area);
             temp.push(d.date_completed);
...
dc.redrawSingle1 = function (group) {
    var charts = dc.chartRegistry.list(group);
    charts[0].redraw();
    if (dc._renderlet !== null) {
        dc._renderlet(group);
...
dc.baseMixin = function (_chart) {
    ...
    **/
    ...
    _chart.redrawGroup1 = function () {
        dc.redrawSingle1(_chart.chartGroup());
    };
...
* chartGroup : string (optional) - name of the chart group this chart instance should be placed in.
 ...
 ```
 **/
dc.selectMenu1 = function (parent, chartGroup) {
    ...
    _chart._doRender = function () {
        ...
        //console.log(_select.append('option').text(_promptText));
        //console.log(_chart);
        renderOptions();
        return _chart;
    };
    ...
    _chart._doRedraw = function () {
        ...
        //console.log("Hello");
        //console.log( _select.property('value', ''));
        return _chart;
    };
